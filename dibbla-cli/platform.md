...
## 9. What the platform does *not* do for you
...
These are application-side concerns. For the security review before deploy, run the OWASP-driven checklist in `guardrails.md` — it is distinct from the compatibility checklist in §10.

---

## 10. Compatibility checklist (will it boot and serve traffic?)
